...
<body class="bg-blue-200 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <form action="{{ route('register.action') }}" method="post" class="w-full">
            @csrf
            @if (session('error'))
                <div class="mb-6">
            ...
            <div class="flex justify-between mb-4">
                <span class="text-sm">
                    ...
                    <a href="{{ route('login') }}" class="text-sm text-end text-blue-900 hover:font-medium">
                        Login here
                    </a>
                </span>
            </div>
            <button type="submit"
                class="w-full h-auto py-4 text-white font-medium  bg-blue-600 rounded-md flex justify-center items-center hover:bg-blue-400">
                Register
            </button>
