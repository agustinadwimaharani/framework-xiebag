...
@section('content')
    ...
    <div
        ...
        <div class="w-1/3 p-8 rounded-xl bg-white text-center divide-y-2 flex flex-col">
            <h1 class="text-3xl mb-4 font-bold">Create Data Tas</h1>
            <form action="{{ route('admin.store') }}" method="post" class="mt-8">
                ...
                <div class="relative mt-4">
                    ...
                    <input type="text" name="merk" placeholder="Merk Tas"
                ...
                <div class="relative mt-4">
                    ...
                    <input type="text" name="warna" placeholder="Warna Tas"
                        class="w-full pl-12 pr-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                </div>
                <div class="relative mt-4">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                    ...
                    <input type="text" name="deskripsi" placeholder="Deskripsi Tas"
                        class="w-full pl-12 pr-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                </div>
                <div class="relative mt-4">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                    ...
                    <input type="text" name="stok" placeholder="Stok Tas"
                        class="w-full pl-12 pr-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                </div>
                <div class="relative mt-4">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                    ...
                    <input type="text" name="harga" placeholder="Harga Tas"
                        class="w-full pl-12 pr-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                </div>
                <div class="relative mt-4">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
